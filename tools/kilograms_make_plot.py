...
parser.add_argument("-c", "--columns", help="Columns to include in plot, in comma-separated list. Will use all if omitted.", type=str, default=None)
parser.add_argument("-o", "--output", help="Output file path. Will display onscreen if omitted.", type=Path, default=None)
parser.add_argument("--force", help="force overwriting of the target path if it exists", action='store_true')
